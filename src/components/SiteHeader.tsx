...
/**
 * The shared sticky top banner: brand on the left, and a reference /
    ...
    <header className="sticky top-0 z-30 border-b border-border bg-background/95 backdrop-blur safe-area-top">
      <div className="mx-auto flex w-full max-w-4xl items-center justify-between gap-3 px-6 py-4">
        <div className="flex items-center gap-3">
          ...
          {/* No sponsor button. Upstream's linked to their GitHub Sponsors page; carrying it in a
              fork would solicit money on someone else's behalf from users who think they're
              supporting this project. RacePlex doesn't ask for money. */}
        </div>
